...
import {GreenButton, CancelButton} from '../components/Buttons'
...
const EditFieldForm = ({field, history, editFieldName, editFieldPic, saveFieldUpdate, removeFourthModal, fieldForm: {name, pic}}) => {
    ...
    const submitHandler = (e) => {
        e.preventDefault()
        saveFieldUpdate(field.id, e.target.field_name.value, e.target.pic.value, history)
        removeFourthModal()
    }
    ...
    return <>
        ...
        <form onSubmit={submitHandler}>
            ...
            <DialogActions>
                <CancelButton onClick={removeFourthModal} />
